...
###################################################
### code chunk number 2: oce.Rnw:129-131 (eval = FALSE)
###################################################
## library(oce)
...
###################################################
### code chunk number 18: oce.Rnw:423-424
###################################################
jpeg("section.jpg", quality=75, width=600, height=700, pointsize=12)


###################################################
### code chunk number 19: oce.Rnw:426-430
###################################################
data(section)
...
###################################################
### code chunk number 20: oce.Rnw:432-433
###################################################
dev.off()


###################################################
### code chunk number 21: oce.Rnw:473-474
###################################################
jpeg("topo.jpg", quality=70, width=800, height=400, pointsize=13)


###################################################
### code chunk number 22: oce.Rnw:476-479
###################################################
library(oce)
data(topoWorld)
...
###################################################
### code chunk number 23: oce.Rnw:481-482
###################################################
dev.off()


###################################################
### code chunk number 24: oce.Rnw:500-501
###################################################
jpeg("sealevel.jpg", quality=70, width=800, height=600, pointsize=20)


###################################################
### code chunk number 25: oce.Rnw:503-507
###################################################
library(oce)
...
###################################################
### code chunk number 26: oce.Rnw:509-510
###################################################
dev.off()


###################################################
### code chunk number 27: oce.Rnw:587-588
###################################################
png("tdr.png", width=600, height=300, pointsize=13)


###################################################
### code chunk number 28: oce.Rnw:590-593
###################################################
library(oce)
data(tdr)
...
###################################################
### code chunk number 29: oce.Rnw:595-596
###################################################
dev.off()


###################################################
### code chunk number 30: oce.Rnw:626-627
###################################################
...
###################################################
### code chunk number 32: oce.Rnw:634-635
###################################################
dev.off()


###################################################
### code chunk number 33: oce.Rnw:660-664
###################################################
library(oce)
...
###################################################
### code chunk number 34: oce.Rnw:725-731
###################################################
library(oce)
swRho(34, 10, 100)
swTheta(34, 10, 100)
...
###################################################
### code chunk number 35: oce.Rnw:736-741
###################################################
library(oce)
data(ctd)
...
###################################################
### code chunk number 36: oce.Rnw:745-749
###################################################
library(oce)
data(ctd)
...
###################################################
### code chunk number 37: oce.Rnw:755-759
###################################################
library(oce)
data(section)
...
###################################################
### code chunk number 38: oce.Rnw:763-774
###################################################
library(oce)
data(section)
SS <- TT <- pp <- id <- NULL
...
###################################################
### code chunk number 39: oce.Rnw:782-795
###################################################
library(oce)
GS <- subset(section, 102<=stationId&stationId<=124)
...
###################################################
### code chunk number 40: oce.Rnw:803-809
###################################################
library(oce)
data(sealevel)
...
###################################################
### code chunk number 41: oce.Rnw:815-817
###################################################
library(oce)
data(sealevel)
...
###################################################
### code chunk number 42: oce.Rnw:820-821
###################################################
elevation <- sealevel[["elevation"]]


###################################################
### code chunk number 43: oce.Rnw:825-828
###################################################
...
###################################################
### code chunk number 44: oce.Rnw:846-847
###################################################
